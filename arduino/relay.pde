...
// THIS IS NOT TESTED. 
    ...
    if( cmd0=='A' && cmd1=='1'){
      sprintf(commandbuffer,"\"A0%04d\"",analogRead(1));
      Serial.println(commandbuffer);
    }
    if( cmd0=='A' && cmd1=='2'){
      sprintf(commandbuffer,"\"A0%04d\"",analogRead(2));
      Serial.println(commandbuffer);
    }
    if( cmd0=='A' && cmd1=='3'){
      sprintf(commandbuffer,"\"A0%04d\"",analogRead(3));
      Serial.println(commandbuffer);
    }
    
    if( cmd0=='A' && cmd1=='4'){
      sprintf(commandbuffer,"\"A0%04d\"",analogRead(4));
      Serial.println(commandbuffer);
    }
    if( cmd0=='A' && cmd1=='5'){
      sprintf(commandbuffer,"\"A0%04d\"",analogRead(5));
      Serial.println(commandbuffer);
    }
